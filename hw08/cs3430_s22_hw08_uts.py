...
class cs3430_s22_hw08_uts(unittest.TestCase):
    ...
    def test_nth_partial_sum_fun_00(self, num_points=10000, num_coeffs=500):
        ...
        yvals2 = np.array(
            [
                nth_partial_sum_of_fourier_series(x, cos_coeffs, sin_coeffs)
                for x in xvals
            ]
        )
        fig1 = plt.figure(1)
    ...
    def test_plot_error_fun_00(self, num_points=10000, num_coeffs=500):
        ...
        fig1 = plt.figure(1)
        fig1.suptitle(
            "True Error for y=x^2; on [{}, {}]; num_coeffs={}".format(a, b, num_coeffs)
        )
        plt.xlabel("x")
    ...
    def test_plot_error_fun_01(self, nsegs=1000, num_points=10000, num_coeffs=500):
        ...
        fig1 = plt.figure(1)
        fig1.suptitle(
            "True Error for y=x^2 + 3; on [{}, {}]; num_coeffs={}".format(
                a, b, num_coeffs
            )
        )
        plt.xlabel("x")
    ...
    def test_plot_error_fun_02(self, nsegs=1000, num_points=10000, num_coeffs=200):
        ...
        fig1 = plt.figure(1)
        fig1.suptitle(
            "True Error for y=4x^2-5; on [{}, {}]; num_coeffs={}".format(
                a, b, num_coeffs
            )
        )
        plt.xlabel("x")
    ...
    def test_plot_error_fun_03(self, nsegs=1000, num_points=10000, num_coeffs=900):
        ...
        fig1 = plt.figure(1)
        fig1.suptitle(
            "True Error for y=x^4; on [{}, {}]; num_coeffs={}".format(a, b, num_coeffs)
        )
        plt.xlabel("x")
        plt.ylabel("True Error")
        plt.grid()
    ...
    def test_plot_error_fun_04(self, nsegs=1000, num_points=10000, num_coeffs=900):
        ...
        fig1 = plt.figure(1)
        fig1.suptitle(
            "True Error for y=-2x^4 + 1; on [{}, {}]; num_coeffs={}".format(a, b, num_coeffs)
        )
        plt.xlabel("x")
        plt.ylabel("True Error")
        plt.grid()
    ...
    def test_plot_error_fun_05(self, nsegs=1000, num_points=10000, num_coeffs=900):
        ...
        fig1 = plt.figure(1)
        fig1.suptitle(
            "True Error for y=cos(x); on [{}, {}]; num_coeffs={}".format(a, b, num_coeffs)
        )
        plt.xlabel("x")
        plt.ylabel("True Error")
        plt.grid()
    ...
    def test_nth_partial_sum_fun_06(self, nsegs=1000, num_points=10000):
        ...
        fig1 = plt.figure(1)
        fig1.suptitle(f"y={fstr}; num_coeff={n}")
        plt.xlabel("x")
        plt.ylabel("y")
        plt.grid()
        plt.plot(xvals, yvals1, label=f"y={fstr}", c="r")
        plt.plot(xvals, yvals2, label="y=nth_partial_sum", c="b")
        plt.legend(loc="best")
        plt.show()
    ...
    def test_plot_error_fun_06(self, nsegs=1000, num_points=10000, num_coeffs=900):
        ...
        err_vals = [gtav[0] - gtav[1] for gtav in zip(gt_vals, approx_vals)]
        fig1 = plt.figure(1)
        fig1.suptitle(f"True Error for y={fstr}; on [{a}, {b}]; num_coeffs={num_coeffs}")
        plt.xlabel("x")
        plt.ylabel("True Error")
        plt.grid()
        plt.plot(xvals, err_vals, label="err", c="b")
    ...
    def test_nth_partial_sum_fun_07(self, nsegs=1000, num_points=10000):
        ...
        fstr = 'cos(x) + 2cos(2x) + 3cos(3x) + 4cos(4x) + 5cos(5x)'
        n = 200
        a, b = -math.pi, math.pi
        cos_coeffs = []
        sin_coeffs = []
    ...
    def test_plot_error_fun_07(self, nsegs=1000, num_points=10000, num_coeffs=900):
        f = (
            lambda x: math.cos(x)
            + 2 * math.cos(2 * x)
            + 3 * math.cos(3 * x)
    ...
    def test_ut_02(self):
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Guitar_A_.wav", lower_k=53, upper_k=57
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
            "Guitar_A",
            "A1",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Guitar_A_.wav", lower_k=3518, upper_k=3522
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Guitar_D_.wav", lower_k=53, upper_k=57
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Guitar_E_.wav", lower_k=53, upper_k=57
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Guitar_G_.wav", lower_k=53, upper_k=57
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Guitar_D_.wav", lower_k=34, upper_k=38
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Guitar_A_.wav", lower_k=34, upper_k=38
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Guitar_D_.wav", lower_k=2347, upper_k=2351
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
    ...
    def test_ut_03(self):
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_A_.wav", lower_k=53, upper_k=57
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_A_.wav", lower_k=108, upper_k=112
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_A_.wav", lower_k=218, upper_k=222
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_A_.wav", lower_k=438, upper_k=442
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_A_.wav", lower_k=878, upper_k=882
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_A_.wav", lower_k=1758, upper_k=1762
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        ### recover A7 - 3520.000
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_A_.wav", lower_k=3518, upper_k=3522
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
    ...
    def test_ut_04(self):
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_G_.wav", lower_k=47, upper_k=50
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_G_.wav", lower_k=96, upper_k=99
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_G_.wav", lower_k=194, upper_k=197
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_G_.wav", lower_k=390, upper_k=393
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_G_.wav", lower_k=782, upper_k=785
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_G_.wav", lower_k=1758, upper_k=1762
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_G_.wav", lower_k=3134, upper_k=3138
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
    ...
    def test_ut_05(self):
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_E_.wav", lower_k=40, upper_k=42
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_E_.wav", lower_k=81, upper_k=84
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_E_.wav", lower_k=327, upper_k=332
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_E_.wav", lower_k=657, upper_k=661
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_E_.wav", lower_k=1317, upper_k=1320
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_E_.wav", lower_k=2636, upper_k=2639
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
    ...
    def test_ut_06(self):
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_E_.wav", lower_k=438, upper_k=442
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_E_.wav", lower_k=389, upper_k=394
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_E_.wav", lower_k=292, upper_k=295
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        ### recover E4 - 329.6276 Hz in Violin_E.wav
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Violin/Violin_E_.wav", lower_k=328, upper_k=332
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
    ...
    def test_ut_07(self):
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Beautiful_Gypsy_Lick_1_.wav", lower_k=878, upper_k=882
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
            "Beautiful_Gypsy_Lick_1",
            "A5",
            lower_k=878,
            upper_k=882,
        )
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Beautiful_Gypsy_Lick_1_.wav", lower_k=586, upper_k=589
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Beautiful_Gypsy_Lick_1_.wav", lower_k=782, upper_k=785
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Beautiful_Gypsy_Lick_1_.wav", lower_k=658, upper_k=661
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
    ...
    def test_ut_09(self):
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Beautiful_Gypsy_Lick_1_.wav", lower_k=1758, upper_k=1762
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Beautiful_Gypsy_Lick_1_.wav", lower_k=1566, upper_k=1569
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Beautiful_Gypsy_Lick_1_.wav", lower_k=1316, upper_k=1321
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Beautiful_Gypsy_Lick_1_.wav", lower_k=1173, upper_k=1176
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
    ...
    def test_ut_10(self):
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Beautiful_Gypsy_Lick_1_.wav", lower_k=3518, upper_k=3522
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Beautiful_Gypsy_Lick_1_.wav", lower_k=3133, upper_k=3137
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Beautiful_Gypsy_Lick_1_.wav", lower_k=2636, upper_k=2639
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
        ...
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Beautiful_Gypsy_Lick_1_.wav", lower_k=2347, upper_k=2352
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
    ...
    def test_ut_11(self):
        note = 3520
        acoeffs, bcoeffs = recover_fourier_coeffs_in_range(
            "Guitar/Beautiful_Gypsy_Lick_2_.wav", lower_k=note-2, upper_k=note+2
        )
        plot_recovered_coeffs(
            acoeffs,
            "ACOEFFS: RCD={}; RCV={} in [{},{}]",
