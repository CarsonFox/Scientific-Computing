...
============ Huffman Tree  UT 4 passed ==============
    ...
    def test_ht_ut05(self, tn=5):
        ...
        print(
            "It took {} bits to encode '{}' as '{}'".format(8 * len(enc0), txt0, enc0)
        )
        bin_enc0, num_bytes0, pad_bits0 = bht.encodeText(txt0)
        print(
            "It took {} bits to encode '{}' as {}".format(
                8 * num_bytes0 + pad_bits0, txt0, bin_enc0
            )
        )
        ...
        print(
            "It took {} bits to encode '{}' as {}".format(
                8 * num_bytes1 + pad_bits1, txt1, bin_enc1
            )
        )
    ...
    def test_ht_ut07(self, tn=7):
        ...
        bht = BinHuffmanTree(root=ht.getRoot())
        bht.encodeTextFromFileToFile(
            work_dir + "moby_dick_ch01.txt", work_dir + "moby_dick_ch01"
        )
    ...
    def test_ht_ut08(self, tn=8):
        ...
        bht = BinHuffmanTree(root=ht.getRoot())
        bht.encodeTextFromFileToFile(
            work_dir + "moby_dick_ch02.txt", work_dir + "moby_dick_ch02"
        )
